    ...
    <div class="searchBar">
        <form action="Products.php?search=" method="get">
            <div class="searchRect">
                ...
                <button type="submit" style="margin-right:10px"><img src="images/search-ICON.png"/></button>
            </div>
    </div>
    <div class="pro_nav">
        <ul>
            <li><a href="Products.php?id=">ALL</a></li>
            <li><a href="Products.php?id=53">LIP BALM</a></li>
            <li><a href="Products.php?id=61">EYELINER</a></li>
            <li><a href="Products.php?id=63">LIPSTICK</a></li>
            <li><a href="Products.php?id=60">COMPACT</a></li>
            <li><a href="Products.php?id=59">LIP GLOSS</a></li>
            <li><a href="Products.php?id=64">MASCARA</a></li>
            <li><a href="Products.php?id=57">LIP OIL</a></li>
        </ul>
    </div>
